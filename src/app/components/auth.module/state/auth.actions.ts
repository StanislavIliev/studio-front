...
export const REQUEST_PASSWORD = '[pages] Request password';
export const RESET_NEW_PASSWORD = '[pages] Reset new password';

export const requestPassword = createAction(REQUEST_PASSWORD);
export const resetNewPassword = createAction(RESET_NEW_PASSWORD);
